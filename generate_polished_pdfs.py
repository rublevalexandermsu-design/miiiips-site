...
PACK = {
    ...
    'miiiips_ei_library_guide.pdf': {
        'title': 'Библиотека курса «Эмоциональный интеллект»',
        'subtitle': 'Маршрут по материалам, лекциям, рабочим тетрадям и самостоятельной практике слушателя.',
        'bullets': ['Подборка материалов делится на открытые лекции, рабочие тетради и тематические чек-листы.', 'Каждый блок связан с кабинетом слушателя, чтобы рекомендации и дедлайны не терялись.', 'Библиотека помогает пройти путь лекция → практика → мини-отчёт → следующий модуль.'],
        'table': [('Раздел','Что внутри','Следующий шаг'), ('Открытые лекции','Видео, тезисы, ссылки на выступления','Выбрать тему и оставить заявку'), ('Рабочие тетради','Чек-листы, наблюдения, заметки','Заполнить мини-отчёт'), ('Кабинет слушателя','Рекомендации, дедлайны, материалы недели','Перейти в личный кабинет')],
        'chart': ([1,2,3], [40, 35, 25], ['Лекции','Практика','Кабинет']),
    },
